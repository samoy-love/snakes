...
/* Сколько миллисекунд идёт текущий матч (0 — вне матча). Наружу — для
   подсказки управления в верхнем HUD, которая гаснет спустя полминуты. */
export function obMatchElapsedMs() {
  return obMatchElapsed();
}
