/* Транспорт: WebSocket, переподключение с задержкой, пинг и счётчики трафика.

   Модуль-фабрика ничего не знает об игре — он отдаёт байты колбэками. Всё
   игровое (разбор пакетов, обновление интерфейса) живёт в
   client_net_bind.js: так логику переподключения видно отдельно от того,
   что именно ездит по проводу. */
